...
export async function initOpponentWorkspace(options: Options) {
  ...
  let message = 'Choose a scenario and the side you want to play.', xrPage: 'home' | 'actions' | 'plan' | 'brief' | 'review' | 'reports' | 'controls' | 'saved' | 'route' | 'orientation' | 'summary' = 'home', xrIndex = 0, fetchGeneration = 0;
